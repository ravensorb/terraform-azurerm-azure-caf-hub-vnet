...
output "firewall_private_ip" {
  ...
  value       = var.create_firewall ? element(concat(azurerm_firewall.fw.*.private_ip_address, [""]), 0) : null
}

output "firewall_id" {
  description = "The Resource ID of the Azure Firewall."
  value       = var.create_firewall ? element(concat(azurerm_firewall.fw.*.id, [""]), 0) : null
}

output "firewall_name" {
  description = "The name of the Azure Firewall."
  value       = var.create_firewall ? element(concat(azurerm_firewall.fw.*.name, [""]), 0) : null
}
